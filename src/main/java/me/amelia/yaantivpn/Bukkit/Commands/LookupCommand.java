package me.amelia.yaantivpn.Bukkit.Commands;
...
public class LookupCommand extends BaseCommand {
    ...
    public void execute(CommandSender sender, OnlinePlayer target) {
        this.bukkit.getThreadPool().execute(() -> {
            ...
            if (player != null && player.isOnline()) {
                ...
                try {
                    ipData = this.bukkit.getAPI().checkIp(player.getAddress().getAddress().getHostAddress());
                } catch (IOException e) {
