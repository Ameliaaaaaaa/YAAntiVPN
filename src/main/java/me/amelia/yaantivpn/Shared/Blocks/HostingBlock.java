...
public class HostingBlock {
    ...
    public HostingBlock(JSONObject ipData, BungeeConfig bungeeConfig) {
        this.ipData = ipData;
        this.blockProvider = bungeeConfig.getBlocks().get("HOSTING");
    }
    ...
    public boolean blockAddress() {
        return (this.blockProvider.isEnabled() && this.ipData.getJSONArray("types").toList().contains(Integer.valueOf(3)));
    }
